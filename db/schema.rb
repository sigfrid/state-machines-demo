...
ActiveRecord::Schema.define(version: 20160321084248) do
  ...
  add_index "boxes", ["flow_id"], name: "index_boxes_on_flow_id"
  add_index "boxes", ["tag_id"], name: "index_boxes_on_tag_id"
